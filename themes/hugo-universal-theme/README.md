...
Officers are defined in the `data` directory.
...
You can add as many officers files as you want. Be sure you fill in all fields as in the following example.
...
avatar: "img/officers/person-1.jpg"
```
...
[params.officers]
    enable = true
    title = "Officers"
    subtitle = "We have worked with many sponsors and we always like to hear they come out from the cooperation happy and satisfied. Have a look what our sponsors said about us."
```
...
The sponsors section is used to show a list of logos of companies you have collaborated with. The sponsors are defined in the `data` directory as YAML files.
...
Each sponsor file contains the following information.

```yaml
name: "customer-1"
image: "img/sponsors/customer-1.png"
url: "http://www.customer-1.com"
```

The `name` of the sponsor. `image` is a relative path to the logo inside the `static` directory. And `url` is an optional field in case you want to link the logo to the sponsor's website.
